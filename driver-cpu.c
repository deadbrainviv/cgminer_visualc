...
extern void submit_work_async(const struct work *work_in, struct timeval2 *tv);
...
const char *algo_names[]={ "c","4way","via","cryptopp_asm32","sse2_32","sse2_64","sse4_64","altivec_4way","scrypt"};

static const sha256_func sha256_funcs[] = {(sha256_func)scanhash_c,
(sha256_func)ScanHash_4WaySSE2,
(sha256_func) ScanHash_altivec_4way,
(sha256_func)scanhash_via,
(sha256_func)scanhash_cryptopp,
(sha256_func)scanhash_asm32,
(sha256_func)scanhash_sse2_32,
(sha256_func)scanhash_sse2_64,
(sha256_func)scanhash_sse4_64,
(sha256_func)scanhash_scrypt
};
#endif
