 ...
 */
static __inline void __list_add(struct list_head *nnew,
 ...
 */
static __inline void list_add(struct list_head *nnew, struct list_head *head)
{
 ...
 */
static __inline void list_add_tail(struct list_head *nnew, struct list_head *head)
{
...
#define list_for_each_entry_safe(a, b, c, d)			\
	for (a = list_entry((c)->next, decltype(*a), d),	\
		b = list_entry(a->d.next, decltype(*a), d);	\
	     &a->d != (c); 					\
	     a = b, b = list_entry(b->d.next, decltype(*b), d))
