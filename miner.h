...
struct cgminer_stats {
	...
	struct timeval2 getwork_wait;
	struct timeval2 getwork_wait_max;
	struct timeval2 getwork_wait_min;
};
...
*/
	...
	enum alive status;
	char init[40];
	struct timeval2 last_message_tv;
...
struct thr_info {
	...
	void *cgpu_data;
	struct timeval2 last;
	struct timeval2 sick;
...
extern double us_tdiff(struct timeval2 *end, struct timeval2 *start);
extern double tdiff(struct timeval2 *end, struct timeval2 *start);
...
extern struct timeval2 block_timeval;
...
struct work {
	...
	struct timeval2	tv_getwork;
	struct timeval2	tv_getwork_reply;
	struct timeval2	tv_cloned;
	struct timeval2	tv_work_start;
...
struct modminer_fpga_state {
	...
	struct timeval2 last_changed;
	struct timeval2 last_nonce;
	struct timeval2 first_work;
...
extern void get_datestamp(char *, struct timeval2 *);
...
extern struct api_data *api_add_timeval2(struct api_data *root, char *name, struct timeval2 *data, bool copy_data);
